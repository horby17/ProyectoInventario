<?php
//Activamos el almacenamiento en el buffer; los resultados de las consultas son transferidos inmediatamente del Servidor MySQL a PHP
ob_start();
session_start();
                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8" id="guardar">
