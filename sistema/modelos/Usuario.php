...
Class Usuario
{
	...
	public function insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos)
	{
		...
		{
			//insertamos los permisos q se le han asignado a cada usuario
	...
	public function listar()
	{
		...
		return ejecutarConsulta($sql);		
	     ...
	     //Implementar un método para listar los permisos marcados a la hora de editar los permisos si se ejecuta la consulta de manera correcta
	public function listarmarcados($idusuario)
	{
		$sql="SELECT * FROM usuario_permiso WHERE idusuario='$idusuario'";
		return ejecutarConsulta($sql);
	}
	//Función para verificar el acceso al sistema solo para aquellos usuarios q esten agregados y q esten activos para acceder al sistema
